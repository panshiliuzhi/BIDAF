...
class LanguageModel(object):
    ...
    def _build_word_embeddings(self):
        ...
        with tf.device("/cpu:0"):
            embedding_addr = "/home/home1/dmyan/codes/bilm-tf/bilm/data/vectors150.txt"
            import gensim
            ...
            self.embedding_weights = tf.get_variable(
                "embedding", [n_tokens_vocab, projection_dim],initializer=tf.constant_initializer(tmp_embed),
...
def train(options, data, n_gpus, tf_save_dir, tf_log_dir,
    ...
    with tf.Session(config=tf.ConfigProto(
        ...
        n_train_tokens = options.get('n_train_tokens', 1191089)
