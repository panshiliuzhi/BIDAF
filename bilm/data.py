...
class TokenBatcher(object):
    ...
    def convert_to_ids(self, tokens):
        return self._lm_vocab.encode(tokens, split=False) + 1
...
class LMDataset(object):
    ...
    def __init__(self, filepattern, vocab, reverse=False, test=False,
        ...
        '''
        filepattern = a glob string that specifies the list of files.(corpus file,one sentence per line)
    ...
    def _load_shard(self, shard_name):
        ...
        把一个文件中的所有句子读入，然后返回对应的word_ids[[1_wids, 2_wids,...],[1_wids, 2_wids,...],...]
        Args:
